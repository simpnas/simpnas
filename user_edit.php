...
<main class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  ...
  <form method="post" action="post.php">
	  ...
	  <div class="form-group form-check">
	    <input type="checkbox" class="form-check-input" name="group[]" <?php foreach ($group_member_array as $group_member) {if($group == $group_member){ echo "checked"; } ?> value="<?php echo "$group"; ?>">
