...
<script>
  ...
  foreach($volume_array as $volume){
    ...
    if(!empty($mounted)){
      ...
      $total_space = exec("df | grep /volumes/$volume | awk '{print $2}'");
      $total_space_formatted = exec("df -h | grep /volumes/$volume | awk '{print $2}'");
      $used_space = exec("df | grep /volumes/$volume | awk '{print $3}'");
      $used_space_formatted = exec("df -h | grep /volumes/$volume | awk '{print $3}'");
      $free_space = exec("df | grep /volumes/$volume | awk '{print $4}'");
      $free_space_formatted = exec("df -h | grep /volumes/$volume | awk '{print $4}'");
      $used_space_percent = exec("df | grep /volumes/$volume | awk '{print $5}'");
