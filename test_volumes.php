      ...
      <tbody>
        ...
        foreach ($volume_array as $volume){     
          ...
          if(empty($mounted)){
            ...
            $total_space = exec("df -h | grep /volumes/$volume | awk '{print $2}'");
            $used_space = exec("df -h | grep /volumes/$volume | awk '{print $3}'");
            $free_space = exec("df -h | grep /volumes/$volume | awk '{print $4}'");
