...
echo ==================================================================================
apt install samba smartmontools rsync php-cgi cryptsetup git mdadm apt-transport-https apt-transport-https curl gnupg-agent software-properties-common -y
