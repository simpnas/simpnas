...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Install Deluge</li>
  </ol>
</nav>
  ...
  <ul>
  	...
  	<li>When Installation is done you can access Deluge by visiting http://<?php echo gethostname(); ?>:8112</li>
